...
/* Define定義                                                                */
/******************************************************************************/
#define MYAPP_APP_NAME          "AD106"
#define RETRY_NAME				"0_BUN"
...
#define BUNCHU_RECV_KIND		"BUN"
#define BUNCHU_RECV_KIND1		"CHK"
#define BUNCHU_RECV_KIND2		"HIBUN"
//  内部ステータスコード定義
typedef enum {
...
//ログファイルINIファイル
#define MYAPP_LOGINIFILE "/home/kea00sys/bin/AD106_LOG.ini"
...
int dBunchu_ins( struct bunchuEnv *, char *, TRAY **s, int *, char *, int );
static int sFncTrFileRead( struct bunchuEnv *, char *, Flbun *, int *, int * );
static char *sFncTrFileToken( char *, char * );
static int sFncFileFillter( struct dirent * );
void nowdateget1( char *sysdttm );
int BunFilePut(struct bunchuEnv *, char *, char *);
//  共有メモリ操作関数
