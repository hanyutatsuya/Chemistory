...
sFncPutLog ( TRCKIND_OPT, __FILE__, "TRACE", __LINE__, 	 EXEFLG_NON, MYAPP_LOG_ERRCODE_NON,	 "TRACE-1");
...
sFncPutLog ( TRCKIND_OPT, __FILE__, "TRACE", __LINE__, 	 EXEFLG_NON, MYAPP_LOG_ERRCODE_NON,	 "TRACE-2");
...
sFncPutLog ( TRCKIND_OPT, __FILE__, "TRACE", __LINE__, 	 EXEFLG_NON, MYAPP_LOG_ERRCODE_NON,	 "TRACE-3");
...
sFncPutLog ( TRCKIND_OPT, __FILE__, "TRACE", __LINE__, 	 EXEFLG_NON, MYAPP_LOG_ERRCODE_NON,	 "TRACE-4");
...
sFncPutLog ( TRCKIND_OPT, __FILE__, "TRACE", __LINE__, 	 EXEFLG_NON, MYAPP_LOG_ERRCODE_NON,	 "TRACE-5");
...
sFncPutLog ( TRCKIND_OPT, __FILE__, "TRACE", __LINE__, 	 EXEFLG_NON, MYAPP_LOG_ERRCODE_NON,	 "TRACE-6");
...
sFncPutLog ( TRCKIND_OPT, __FILE__, "TRACE", __LINE__, 	 EXEFLG_NON, MYAPP_LOG_ERRCODE_NON,	 "TRACE-7");
...
sFncPutLog ( TRCKIND_OPT, __FILE__, "TRACE", __LINE__, 	 EXEFLG_NON, MYAPP_LOG_ERRCODE_NON,	 "TRACE-8");
...
sFncPutLog ( TRCKIND_OPT, __FILE__, "TRACE", __LINE__, 	 EXEFLG_NON, MYAPP_LOG_ERRCODE_NON,	 "TRACE-9");
...
/*** -> */
sFncPutLog ( TRCKIND_OPT, __FILE__, "TRACE", __LINE__, 	 EXEFLG_NON, MYAPP_LOG_ERRCODE_NON,	 "TRACE-10");
				lRet = procFile(pAppEnv,lpst_dirBuf[li_idx]->d_name,recBuf,&stOutput,sOutChgFlg);
sFncPutLog ( TRCKIND_OPT, __FILE__, "TRACE", __LINE__, 	 EXEFLG_NON, MYAPP_LOG_ERRCODE_NON,	 "TRACE-11");
/*** <- */
				if(lRet == 0){
...
sFncPutLog ( TRCKIND_OPT, __FILE__, "TRACE", __LINE__, 	 EXEFLG_NON, MYAPP_LOG_ERRCODE_NON,	 "TRACE-12");
...
sFncPutLog ( TRCKIND_OPT, __FILE__, "TRACE", __LINE__, 	 EXEFLG_NON, MYAPP_LOG_ERRCODE_NON,	 "TRACE-13");

			fclose ( fp ) ;
			if(nBreakFlg == 0){

sFncPutLog ( TRCKIND_OPT, __FILE__, "TRACE", __LINE__, 	 EXEFLG_NON, MYAPP_LOG_ERRCODE_NON,	 "TRACE-14-1");
...
sFncPutLog ( TRCKIND_OPT, __FILE__, "TRACE", __LINE__, 	 EXEFLG_NON, MYAPP_LOG_ERRCODE_NON,	 "TRACE-14-2");
...
sFncPutLog ( TRCKIND_OPT, __FILE__, "TRACE", __LINE__, 	 EXEFLG_NON, MYAPP_LOG_ERRCODE_NON,	 "TRACE-15");
...
sFncPutLog ( TRCKIND_OPT, __FILE__, "TRACE", __LINE__, 	 EXEFLG_NON, MYAPP_LOG_ERRCODE_NON,	 "TRACE-16");
...
sFncPutLog ( TRCKIND_OPT, __FILE__, "TRACE", __LINE__, 	 EXEFLG_NON, MYAPP_LOG_ERRCODE_NON,	 "TRACE-A");

/*** 64項目制限対応 上位からの要求(ファイル)を無視して、IRAI情報から項目を作る -> ***/
/*	if(stOutput->nPos == MYAPP_KMKCD_START_POS){	*/
/*		//初回処理－何もしない	*/
/*	}	*/
...
sFncPutLog ( TRCKIND_OPT, __FILE__, "TRACE", __LINE__, 	 EXEFLG_NON, MYAPP_LOG_ERRCODE_NON,	 "TRACE-B");
...
sFncPutLog ( TRCKIND_OPT, __FILE__, "procFile", __LINE__, 	 EXEFLG_NON, MYAPP_LOG_ERRCODE_NON,	 "%4.4s-%2.2s-%2.2s",
																								stINPUT.utkymd,&stINPUT.utkymd[4],&stINPUT.utkymd[6]);
sFncPutLog ( TRCKIND_OPT, __FILE__, "procFile", __LINE__, 	 EXEFLG_NON, MYAPP_LOG_ERRCODE_NON,	 "00%-3.3s%-4.4s00",stINPUT.kntno, stINPUT.kntno[5]);

	sprintf ( utkymd , "%4.4s-%2.2s-%2.2s",						/* 受付日付の取得 */
		  stINPUT.utkymd,&stINPUT.utkymd[4],&stINPUT.utkymd[6]);

sFncPutLog ( TRCKIND_OPT, __FILE__, "TRACE", __LINE__, 	 EXEFLG_NON, MYAPP_LOG_ERRCODE_NON,	 "TRACE-AtoB");

	sprintf (irino,"00%-3.3s%-4.4s00",stINPUT.kntno, stINPUT.kntno[5]);
																/* 検体Noから依頼書Noの取得(00xxxxxxx00形式) */

sFncPutLog ( TRCKIND_OPT, __FILE__, "TRACE", __LINE__, 	 EXEFLG_NON, MYAPP_LOG_ERRCODE_NON,	 "TRACE-C");
...
sFncPutLog ( TRCKIND_OPT, __FILE__, "TRACE", __LINE__, 	 EXEFLG_NON, MYAPP_LOG_ERRCODE_NON,	 "TRACE-D");
...
sFncPutLog ( TRCKIND_OPT, __FILE__, "TRACE", __LINE__, 	 EXEFLG_NON, MYAPP_LOG_ERRCODE_NON,	 "TRACE-E");

	if(lRet == MYAPP_SQL_DEADLOCK || lRet== MYAPP_SQL_DUPLICATION)
	{

sFncPutLog ( TRCKIND_OPT, __FILE__, "TRACE", __LINE__, 	 EXEFLG_NON, MYAPP_LOG_ERRCODE_NON,	 "TRACE-F-1");
...
sFncPutLog ( TRCKIND_OPT, __FILE__, "TRACE", __LINE__, 	 EXEFLG_NON, MYAPP_LOG_ERRCODE_NON,	 "TRACE-F-2");
...
sFncPutLog ( TRCKIND_OPT, __FILE__, "TRACE", __LINE__, 	 EXEFLG_NON, MYAPP_LOG_ERRCODE_NON,	 "TRACE-G");
...
sFncPutLog ( TRCKIND_OPT, __FILE__, "TRACE", __LINE__, 	 EXEFLG_NON, MYAPP_LOG_ERRCODE_NON,	 "TRACE-H");

	g_strKinkmmst= NULL;
    g_nKinkmmst = 0;
	sprintf(kmkcd,"%s",stINPUT.kmkcd);
	sFncPutLog ( TRCKIND_DEBUG, __FILE__, "", __LINE__,
            EXEFLG_NON, MYAPP_LOG_ERRCODE_NON,
            "緊急項目マスタ検索<項目コード:%s>",kmkcd);
	lRet = KinkmmstSelectKey(kmkcd, &g_strKinkmmst,&g_nKinkmmst);

sFncPutLog ( TRCKIND_OPT, __FILE__, "TRACE", __LINE__, 	 EXEFLG_NON, MYAPP_LOG_ERRCODE_NON,	 "TRACE-I");

	if(lRet == MYAPP_SQL_DEADLOCK || lRet== MYAPP_SQL_DUPLICATION)
    {

sFncPutLog ( TRCKIND_OPT, __FILE__, "TRACE", __LINE__, 	 EXEFLG_NON, MYAPP_LOG_ERRCODE_NON,	 "TRACE-J-1");
...
sFncPutLog ( TRCKIND_OPT, __FILE__, "TRACE", __LINE__, 	 EXEFLG_NON, MYAPP_LOG_ERRCODE_NON,	 "TRACE-J-2");
...
sFncPutLog ( TRCKIND_OPT, __FILE__, "TRACE", __LINE__, 	 EXEFLG_NON, MYAPP_LOG_ERRCODE_NON,	 "TRACE-K");
...
sFncPutLog ( TRCKIND_OPT, __FILE__, "TRACE", __LINE__, 	 EXEFLG_NON, MYAPP_LOG_ERRCODE_NON,	 "TRACE-L");

	char tmp_smpcd[8] = {0,};
	strcpy(tmp_smpcd,g_strKinkmmst[0].smpcd);
	free(g_strKinkmmst);
...
sFncPutLog ( TRCKIND_OPT, __FILE__, "TRACE", __LINE__, 	 EXEFLG_NON, MYAPP_LOG_ERRCODE_NON,	 "TRACE-M");

	lRet=selectIRAI(utkymd, irino, tmp_smpcd, kmkcd, &nLotno, &nRecCnt);
	if(lRet == MYAPP_SQL_DEADLOCK || lRet== MYAPP_SQL_DUPLICATION)
	{

sFncPutLog ( TRCKIND_OPT, __FILE__, "TRACE", __LINE__, 	 EXEFLG_NON, MYAPP_LOG_ERRCODE_NON,	 "TRACE-N-1");
...
sFncPutLog ( TRCKIND_OPT, __FILE__, "TRACE", __LINE__, 	 EXEFLG_NON, MYAPP_LOG_ERRCODE_NON,	 "TRACE-N-2");
...
sFncPutLog ( TRCKIND_OPT, __FILE__, "TRACE", __LINE__, 	 EXEFLG_NON, MYAPP_LOG_ERRCODE_NON,	 "TRACE-O");
...
sFncPutLog ( TRCKIND_OPT, __FILE__, "TRACE", __LINE__, 	 EXEFLG_NON, MYAPP_LOG_ERRCODE_NON,	 "TRACE-P");
...
sFncPutLog ( TRCKIND_OPT, __FILE__, "TRACE", __LINE__, 	 EXEFLG_NON, MYAPP_LOG_ERRCODE_NON,	 "TRACE-Q");
